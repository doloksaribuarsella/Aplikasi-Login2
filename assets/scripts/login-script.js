...
/**
* Membuat variabel inputPasswordlElement untuk tampilan input password.
* @constant {HTMLElement}
*/
...
/* Comment : Menambahkan aksi klik ppada button. */
...
const password = inputPasswordElement.value;
  ...
  if (email == expectedEmail && password == expectedPassword) {
    ...
    /* Comment : Namun jika tidak sesuai maka program akan menampilkan informasi bahwa input salah. */
    showPopUp();
  }
});
